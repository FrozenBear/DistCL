...
namespace DistCL.Utils
{
    ...
    public sealed class ProcessRunner
    {
        ...
        public static int Run(string fileName, string arguments,
                              TextWriter stdOutput, TextWriter errOutput)
        {
        ...
        private static void ReadProcessOutput(Process cmdLineProcess,
                                              TextWriter stdOutput, TextWriter errorOutput)
        {
            
            cmdLineProcess.OutputDataReceived += (sender, args) => 
                stdOutput.Write(args.Data);
