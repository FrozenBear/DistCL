...
namespace DistCL.RemoteCompilerService {
    ...
    public partial class CompileManagerClient : System.ServiceModel.ClientBase<DistCL.RemoteCompilerService.ICompileManager>, DistCL.RemoteCompilerService.ICompileManager {
        ...
        public DistCL.RemoteCompilerService.CompileStatus Compile(string Arguments, DistCL.Utils.CompileArtifactCookie[] Artifacts, string CompilerVersion, long SrcLength, System.IO.Stream Src, out System.IO.Stream ResultData) {
        ...
        public System.Threading.Tasks.Task<DistCL.RemoteCompilerService.CompileOutput> CompileAsync(string Arguments, DistCL.Utils.CompileArtifactCookie[] Artifacts, string CompilerVersion, long SrcLength, System.IO.Stream Src) {
            DistCL.RemoteCompilerService.CompileInput inValue = new DistCL.RemoteCompilerService.CompileInput();
            inValue.Arguments = Arguments;
            inValue.Artifacts = Artifacts;
            inValue.CompilerVersion = CompilerVersion;
